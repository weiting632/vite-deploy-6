...
export default {
    template: `
    <div class="modal-dialog modal-xl" id="product-modal-template">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-sm-8">
              ...
              <div class="row">
                <div class="mb-3 col-md-6">
                  <label for="origin_price" class="form-label text-center">原價</label>
                  <input id="origin_price" v-model.number="tempProduct.origin_price" type="number" min="0"
                    class="form-control " placeholder="請輸入原價">
                </div>
                <div class="mb-3 col-md-6">
                  <label for="price" class="form-label ">售價</label>
                  <input id="price" v-model.number="tempProduct.price" type="number" min="0" class="form-control text-center"
                    placeholder="請輸入售價">
                </div>
              </div>
              <hr>
