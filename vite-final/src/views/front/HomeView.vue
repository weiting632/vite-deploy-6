...
export default{
    ...
    computed:{
      ...mapState(cartStore,['productId','isProductLoad'])
    },
    components:{
      RouterLink,
      Swiper,
...
<template>
     <div class="">
        <div class="banner  d-flex flex-column fw-bold  align-items-center justify-content-center img-fluid  " style="background-image: url(https://images.unsplash.com/photo-1627373717559-17b8b84b2c84?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80);" >
            <h1 class=" text-white fw-bold">歡聚時刻 首選星杯</h1>
            <RouterLink class="btn btn-to-shop btn-outline bg-success text-white px-7 mt-4 noopacity" to="/products">來去看看</RouterLink>
        </div>
      ...
      <div class="">
        <div class="container " >
        <h2 class="text-center p-5 fw-bold">聚會首選</h2>
        <section class="py-5 text-center">
          <div class="container">
            <!-- 區塊一 -->
            <div class="row gx-lg-5 align-items-center flex-row-reverse ">
              <div class="col-lg-6">
                  <h4 class="fw-bold">
                  ...
                  <div class="mt-6 mb-4"> 
                    <span class="px-2">
                      <i class="bi bi-snow2 icon-color"></i>
                    </span>
                    <span class="px-2">
                      <i class="bi bi-snow2 icon-color"></i>
                    </span>
              ...
              <div class="col-lg-6 mb-lg-0 mb-4 zoom-effect">
            ...
            <div class="row gx-lg-5 align-items-center  ">
              <div class="col-lg-6">
                <h4 class="fw-bold">還在為送禮要送什麼煩惱嗎?<br><br><br><br>選擇星杯冰淇淋讓您大方不落伍
                </h4>
                <div class="mt-6 mb-4"> 
                    <span class="px-2">
                      <i class="bi bi-snow2 icon-color"></i>
              ...
              <swiper-slide v-for="product in products " :key="product.id" >
                <div class="w-100  ">
                  <div class="card border-0   ">
                    <RouterLink :to="`/products/${product.id}`" class="position-relative">
                    ...
                    <div class="card-body pt-0 mb-6 bg-primary ">
                      ...
                      <a href="#" class="text-nowrap btn btn-dark w-100 py-2  position-relative"  
