...
<template>
    <div class="container">
      <div class="row ">
        <div class="col-md-12 text-center align-items-center my-8" v-if="carts.length===0">
          <h2>購物車沒有產品</h2>
          ...
          <div class="col-md-8" :class="{'d-none': carts.length ===0 }">
          ...
          <div class="col-md-4   mb-5  mt-md-17 mt-sm-5 d-none d-md-block " >
              <div class="card bg-light"  :class="{'d-none': carts.length ===0 }" >
            ...
            <div class="card mt-6 "  :class="{'d-none': carts.length ===0 }" >
                   ...
                   <tbody >
                     <tr class="border-bottom " v-for="item in carts" :key="item.id">
                      <div class="d-flex  ">
                       ...
                       <td class="pb-2">
                          <span class="px-4 text-nowrap">{{ item.product.title }}</span>
                          <br>
                          <small class="px-4">{{ item.qty }} 個</small>
                          <br>
